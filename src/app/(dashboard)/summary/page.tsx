                      ...
                      <TableBody>
                        {filteredData.map((item: any, idx: number) => (
                          <TableRow key={idx} className="hover:bg-muted/30">
                            ...
                            <TableCell className="text-xs text-center">
                              ${item.reconciliation?.toLocaleString() || "-"}
                            </TableCell>
                            <TableCell className="text-xs text-center">
                              ${item.adjustment?.toLocaleString() || "-"}
                            </TableCell>
                            <TableCell className="text-xs text-center">
                              ${item.transport?.toLocaleString() || "-"}
                            </TableCell>
                            <TableCell className="text-xs text-center">
                            ...
                            <TableCell className="text-xs text-center">
                              ${item.accessCredit?.toLocaleString() || "-"}
                            </TableCell>
                            <TableCell className="text-xs text-center">
                              ${item.displayedPrice?.toLocaleString() || "-"}
                            </TableCell>
                            <TableCell className="text-xs text-center">
                            ...
                            <TableCell className="text-xs text-center">
                              <span
                                className={`px-2 py-1 rounded text-xs font-medium ${item.sellStatus ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}`}
                              >
